...
{
    UIButton *btn = [[ColorButton alloc]initWithFrame:pFrame pColorNormal:[StyleKit colorOfBaseDeep] pColorSelected:[UIColor grayColor]];
    btn.titleLabel.font = [UIFont boldSystemFontOfSize: 14.0];
    [btn setTitleColor:[StyleKit colorOfWhite] forState:UIControlStateNormal];
    return btn;
}
+ (UIButton *)createGrayRadius:(CGRect)pFrame
{
    UIButton *btn = [[ColorButton alloc]initWithFrame:pFrame pColorNormal:[UIColor grayColor] pColorSelected:[UIColor blackColor]];
    btn.titleLabel.font = [UIFont boldSystemFontOfSize: 14.0];
    return btn;
}
+ (UIButton *)createOrangeRadius:(CGRect)pFrame
{
    UIButton *btn = [[ColorButton alloc]initWithFrame:pFrame pColorNormal:[UIColor orangeColor] pColorSelected:[UIColor grayColor]];
    btn.titleLabel.font = [UIFont boldSystemFontOfSize: 14.0];
    return btn;
}
+ (UIButton *)createWhiteNotRadius:(CGRect)pFrame
{
    UIButton *btn = [[ColorButton alloc]initWithFrame:pFrame pRadius:NO pColorNormal:[UIColor whiteColor] pColorSelected:[UIColor grayColor]];
    btn.titleLabel.font = [UIFont boldSystemFontOfSize: 14.0];
    return btn;
}
@end
...
+ (BOOL) isValidPhone:(NSString*)value {
    ...
    if (![NSString isValidNumber:value])
    {
        return FALSE;
    }
...
+ (BOOL) isValid:(IdentifierType) type value:(NSString*) value
{
    ...
    switch (type)
    {
        case IdentifierTypeZipCode:
            result = [NSString isValidZipcode:value];
            break;
        case IdentifierTypeEmail:
            //            result = [IdentifierValidator isValidEmail:value];
            result = [NSString validateEmail:value];
            break;
        case IdentifierTypePhone:
            result = [NSString isValidPhone:value];
            break;
        case IdentifierTypeUnicomPhone:
            result = [NSString isChinaUnicomPhoneNumber:value];
            break;
        ...
        case IdentifierTypeString:
            result = [NSString isValidString:value];
            break;
        case IdentifierTypeIdentifier:
            result = [NSString isValidIdentifier:value];
            break;
        case IdentifierTypePassort:
            result = [NSString isValidPassport:value];
            break;
        case IdentifierTypeCreditNumber:
            result = [NSString isValidCreditNumber:value];
            break;
        case IdentifierTypeBirthday:
            result = [NSString isValidBirthday:value];
            break;
        default:
            break;
    }
