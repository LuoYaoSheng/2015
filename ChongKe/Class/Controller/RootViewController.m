...
- (void)DATA_init
{
    ...
    if ( 10 == level_s ) {
        ...
        titles = [NSArray arrayWithObjects:@"",@"我的重要集团", @"管理客户经理", @"修改图形密码", @"修改登录密码", @"检查更新", @"意见反馈", @"关于我们",@"注销登录", nil];
        ...
        titles = [NSArray arrayWithObjects:@"",@"我的重要集团", @"修改图形密码", @"修改登录密码", @"检查更新", @"意见反馈", @"关于我们",@"注销登录", nil];
